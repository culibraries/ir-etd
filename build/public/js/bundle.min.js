...
function Archive(e){this.name=e.name,this.status=e.status,this.contents=e.contents,this.archiveUrl=e.archiveUrl,this.batchUrl=e.batchUrl,this.getPdf=function(){for(var e=0;e<this.contents.length;e++)if("pdf"===this.contents[e].substr(-3))return this.contents[e]},this.pdf=this.getPdf(),this.json=JSON.parse(stripChars(e.json)),this.db=e.db,this.subId=e.subId}function refreshSideBar(){getOldestArchive().done(function(e){e.numArchives?($("#oldestArchive").text(e.oldestArchive),$("#numArchives").text(e.numArchives)):($("#oldestArchive").text("No more archives"),$("#loadOldestArchive").hide())}),getArchives().done(function(e){displayArchives(e)})}function displayArchives(e){for(var r="",t="",i="",s=0;s<e.length;s++)switch(e[s].workflow_status){case"W":r+='<a href="#" class="getme" subId="'+e[s].submission_id+'" archive="'+e[s].sequence_num+'" status="'+e[s].workflow_status+'">'+e[s].identikey+"-"+e[s].sequence_num+"</a><br>";break;case"P":t+='<a href="#" class="getme" subId="'+e[s].submission_id+'" archive="'+e[s].sequence_num+'" status="'+e[s].workflow_status+'">'+e[s].identikey+"-"+e[s].sequence_num+"</a><br>";break;case"L":i+='<a href="#" class="getme" subId="'+e[s].submission_id+'" archive="'+e[s].sequence_num+'" status="'+e[s].workflow_status+'">'+e[s].identikey+"-"+e[s].sequence_num+"</a><br>"}$("#working").html(r),$("#pending").html(t),$("#problem").html(i)}function clearViews(){$(".xmlEditBtns").hide(),$("#xmlEdit").empty(),$("#top").empty(),$("#archiveFiles").empty()}function calcRows(e){return Math.round(e/20)-1}function stripChars(e){var r={"@attributes":"attributes",DISS_:""};return e=e.replace(/@attributes|DISS_/g,function(e){return r[e]})}function getOldestArchive(){var e=$.Deferred();return $.ajax({url:"modules/archive/archive.php",type:"GET",data:{action:"getOldestArchive"},success:function(r,t){e.resolve(JSON.parse(r))},error:function(e,r,t){console.log(e),console.log("Details: "+r+"\nError: "+t)}}),e.promise()}function getArchives(){var e=$.Deferred();return $.ajax({url:"modules/archive/archive.php",type:"GET",data:{action:"getArchives"},success:function(r,t){e.resolve(JSON.parse(r))},error:function(e,r,t){console.log(e),console.log("Details: "+r+"\nError: "+t)}}),e.promise()}function getOneArchive(e,r,t){var i=$.Deferred();return"oldest"===r?$.ajax({url:"modules/archive/archive.php",type:"GET",datatype:"JSON",data:{action:"getExtractOldestArchive"},success:function(e,r){i.resolve(JSON.parse(e))},error:function(e,r,t){console.log(e),console.log("Details: "+r+"\nError: "+t)}}):$.ajax({url:"modules/archive/archive.php",type:"GET",datatype:"JSON",data:{action:"getOneArchive",status:t,subId:r,archive:e},success:function(e,r){i.resolve(JSON.parse(e))},error:function(e,r,t){console.log(e),console.log("Details: "+r+"\nError: "+t)}}),i.promise()}function prepBatch(){var e=$.Deferred();return $.ajax({url:"modules/archive/archive.php",type:"POST",data:{action:"prepBatch"},success:function(r,t){e.resolve(JSON.parse(r))},error:function(e,r,t){console.log(e),console.log("Details: "+r+"\nError: "+t)}}),e.promise()}var currentArchive;refreshSideBar(),Archive.prototype.parseArchiveFiles=function(){for(var e="",r=2;r<this.contents.length;r++){var t=this.contents[r],i=t.substr(-3);"xml"!==i&&(e+='<a target="_blank" href="'+this.archiveUrl+t+'">'+t+"</a><br>")}return e},Archive.prototype.preFillForm=function(e){var r=$.Deferred();$("#xmlEdit").empty();for(var t in e){var i='<div class="form-group"><label for="'+e[t].id+'">'+e[t].name+"</label></div>";switch($("#xmlEdit").append(i),e[t].type){case"text-long":$("label:last").after('<textarea class="form-control" id="'+e[t].id+'" name="'+e[t].id+'"></textarea>'),$("#"+e[t].id).val(e[t].data);var s=calcRows($("#"+e[t].id)[0].scrollHeight);$("#"+e[t].id).attr("rows",s);break;case"text":case"date":$("label:last").after('<input class="form-control" id="'+e[t].id+'" name="'+e[t].id+'">'),$("#"+e[t].id).attr("type",e[t].type).val(e[t].data).attr("readonly",e[t].readonly);break;case"drop-down":var n='<select class="form-control" name="'+e[t].id+'" id="'+e[t].id+'"><option value="W">Working</option><option value="P">Pending</option><option value="L">Problem</option></select>';$("label:last").after(n),$("#"+e[t].id).val(e[t].data)}}return r.resolve(),$(".xmlEditBtns").show(),r.promise()},Archive.prototype.postFormData=function(){var e=$.Deferred();return $.ajax({url:"modules/archive/archive.php",type:"POST",data:{action:"postFormData",subId:this.subId,data:$("#xmlEdit").serialize()},success:function(r,t){console.log(r),e.resolve(JSON.parse(r))},error:function(e,r,t){console.log(e),console.log("Details: "+r+"\nError: "+t)}}),e.promise()},$(document).ready(function(){$("#loadOldestArchive").click(function(){getOneArchive(null,"oldest",null).done(function(e){currentArchive=new Archive(e),visualize(currentArchive.json),$("#archiveFiles").html(currentArchive.parseArchiveFiles()),currentArchive.preFillForm(currentArchive.mapJson()).done(function(e){currentArchive.postFormData().done(function(e){currentArchive.subId=e.id,refreshSideBar()})})})}),$(".submit").click(function(){currentArchive.postFormData().done(function(e){refreshSideBar(),clearViews()})}),$("#prepBatch").click(function(){prepBatch().done(function(e){})})}),$(document).on("click",".getme",function(e){var r=e.target.attributes.subId.textContent,t=e.target.attributes.archive.textContent,i=e.target.attributes.status.textContent;getOneArchive(t,r,i).done(function(e){currentArchive=new Archive(e),visualize(currentArchive.json),$("#archiveFiles").html(currentArchive.parseArchiveFiles()),currentArchive.preFillForm(currentArchive.mapDb())})});
Archive.prototype.mapDb=function(){return[{name:"Editor",id:"identikey",data:identikey,type:"text",readonly:!0},{name:"Archive Name",id:"sequence_num",data:this.name,type:"text",readonly:!0},{name:"Workflow Status",id:"workflow_status",data:this.status,type:"drop-down",readonly:!0},{name:"Title",id:"title",data:this.db.title,type:"text-long",readonly:!1},{name:"Full Text Url",id:"fulltext_url",data:this.batchUrl+this.name+"/"+this.pdf,type:"text",readonly:!0},{name:"Keywords",id:"keywords",data:this.db.keywords,type:"text-long",readonly:!1},{name:"Abstract",id:"abstract",data:this.db.abstract,type:"text-long",readonly:!1},{name:"Author1 FName",id:"author1_fname",data:this.db.author1_fname,type:"text",readonly:!1},{name:"Author1 MName",id:"author1_mname",data:this.db.author1_mname,type:"text",readonly:!1},{name:"Author1 LName",id:"author1_lname",data:this.db.author1_lname,type:"text",readonly:!1},{name:"Author1 Suffix",id:"author1_suffix",data:this.db.author1_suffix,type:"text",readonly:!1},{name:"Author1 Email",id:"author1_email",data:this.db.author1_email,type:"email",readonly:!1},{name:"Author1 Institution",id:"author1_institution",data:this.db.author1_institution,type:"text",readonly:!1},{name:"Advisor1",id:"advisor1",data:this.db.advisor1,type:"text",readonly:!1},{name:"Advisor2",id:"advisor2",data:this.db.advisor2,type:"text",readonly:!1},{name:"Advisor3",id:"advisor3",data:this.db.advisor3,type:"text",readonly:!1},{name:"Advisor4",id:"advisor4",data:this.db.advisor4,type:"text",readonly:!1},{name:"Advisor5",id:"advisor5",data:this.db.advisor5,type:"text",readonly:!1},{name:"Disciplines",id:"disciplines",data:this.db.disciplines,type:"text",readonly:!1},{name:"Comments",id:"comments",data:this.db.comments,type:"text",readonly:!1},{name:"Degree Name",id:"degree_name",data:this.db.degree_name,type:"text",readonly:!1},{name:"Department",id:"department",data:this.db.department,type:"text",readonly:!1},{name:"Document Type",id:"document_type",data:this.db.document_type,type:"text",readonly:!1},{name:"Embargo Date",id:"embargo_date",data:this.db.embargo_date,type:"date",readonly:!1},{name:"Publication Date",id:"publication_date",data:this.db.publication_date,type:"date",readonly:!1},{name:"Season",id:"season",data:this.db.season,type:"text",readonly:!1}]};
Archive.prototype.mapJson=function(){return[{name:"Editor",id:"identikey",data:identikey,type:"text",readonly:!0},{name:"Archive Name",id:"sequence_num",data:this.name,type:"text",readonly:!0},{name:"Workflow Status",id:"workflow_status",data:this.status,type:"drop-down",readonly:!0},{name:"Title",id:"title",data:this.json.description.title.toTitleCase(),type:"text-long",readonly:!1},{name:"Full Text Url",id:"fulltext_url",data:this.batchUrl+this.name+"/"+this.pdf,type:"text",readonly:!0},{name:"Keywords",id:"keywords",data:this.json.description.categorization.keyword,type:"text-long",readonly:!1},{name:"Abstract",id:"abstract",data:concatParas(this.json.content.abstract.para),type:"text-long",readonly:!1},{name:"Author1 FName",id:"author1_fname",data:this.json.authorship.author.name.fname,type:"text",readonly:!1},{name:"Author1 MName",id:"author1_mname",data:this.json.authorship.author.name.middle[0]?this.json.authorship.author.name.middle:void 0,type:"text",readonly:!1},{name:"Author1 LName",id:"author1_lname",data:this.json.authorship.author.name.surname,type:"text",readonly:!1},{name:"Author1 Suffix",id:"author1_suffix",data:this.json.authorship.author.name.suffix[0]?this.json.authorship.author.name.suffix:void 0,type:"text",readonly:!1},{name:"Author1 Email",id:"author1_email",data:this.json.authorship.author.contact[1].email||this.json.authorship.author.contact[0].email,type:"email",readonly:!1},{name:"Author1 Institution",id:"author1_institution",data:this.json.description.institution.inst_name,type:"text",readonly:!1},{name:"Advisor1",id:"advisor1",data:this.json.description.cmte_member[0]?this.json.description.cmte_member[0].name.surname+", "+this.json.description.cmte_member[0].name.fname:void 0,type:"text",readonly:!1},{name:"Advisor2",id:"advisor2",data:this.json.description.cmte_member[1]?this.json.description.cmte_member[1].name.surname+", "+this.json.description.cmte_member[1].name.fname:void 0,type:"text",readonly:!1},{name:"Advisor3",id:"advisor3",data:this.json.description.cmte_member[2]?this.json.description.cmte_member[2].name.surname+", "+this.json.description.cmte_member[2].name.fname:void 0,type:"text",readonly:!1},{name:"Advisor4",id:"advisor4",data:this.json.description.cmte_member[3]?this.json.description.cmte_member[3].name.surname+", "+this.json.description.cmte_member[3].name.fname:void 0,type:"text",readonly:!1},{name:"Advisor5",id:"advisor5",data:this.json.description.cmte_member[4]?this.json.description.cmte_member[4].name.surname+", "+this.json.description.cmte_member[4].name.fname:void 0,type:"text",readonly:!1},{name:"Disciplines",id:"disciplines",data:this.json.description.institution.inst_contact,type:"text",readonly:!1},{name:"Comments",id:"comments",data:"",type:"text",readonly:!1},{name:"Degree Name",id:"degree_name",data:this.json.description.degree.replace(/\./g,""),type:"text",readonly:!1},{name:"Department",id:"department",data:this.json.description.institution.inst_contact,type:"text",readonly:!1},{name:"Document Type",id:"document_type",data:"doctoral"===this.json.description.attributes.type?"Dissertation":"Thesis",type:"text",readonly:!1},{name:"Embargo Date",id:"embargo_date",data:embargoDate(this.json.attributes.embargo_code),type:"date",readonly:!1},{name:"Publication Date",id:"publication_date",data:this.json.description.dates.comp_date+"-01-01",type:"date",readonly:!1},{name:"Season",id:"season",data:"Spring",type:"text",readonly:!1}]},String.prototype.toTitleCase=function(){var t,e,a,n,i;for(a=this.replace(/([^\W_]+[^\s-]*) */g,function(t){return t.charAt(0).toUpperCase()+t.substr(1).toLowerCase()}),n=["A","An","The","And","But","Or","For","Nor","As","At","By","For","From","In","Into","Near","Of","On","Onto","To","With"],t=0,e=n.length;t<e;t++)a=a.replace(new RegExp("\\s"+n[t]+"\\s","g"),function(t){return t.toLowerCase()});for(i=["Id","Tv"],t=0,e=i.length;t<e;t++)a=a.replace(new RegExp("\\b"+i[t]+"\\b","g"),i[t].toUpperCase());return a};var embargoDate=function(t){var e=new Date,a=("0"+e.getDate()).slice(-2),n=("0"+(e.getMonth()+1)).slice(-2),i=e.getFullYear()+"-"+n+"-"+a;if("0"===t)return i},concatParas=function(t){if("object"==typeof t){for(var e="",a=0;a<t.length;a++)e+="<p>"+t[a]+"</p>";return e}return t};
