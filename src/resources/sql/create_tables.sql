...
CREATE TABLE submission (
	...
	author1_fname VARCHAR(20) NOT NULL,
	author1_mname VARCHAR(20) NOT NULL,
	author1_lname VARCHAR(20) NOT NULL,
	author1_suffix VARCHAR(10) NOT NULL,
	author1_email VARCHAR(50) NOT NULL,
	author1_institution VARCHAR(50) NOT NULL,
	advisor1 VARCHAR(20) NOT NULL,
	advisor2 VARCHAR(20) NOT NULL,
	advisor3 VARCHAR(20) NOT NULL,
	advisor4 VARCHAR(20) NOT NULL,
	advisor5 VARCHAR(20) NOT NULL,
